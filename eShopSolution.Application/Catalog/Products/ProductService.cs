...
namespace eShopSolution.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public async Task<int> AddImage(int productId, ProductCreateImageRequest request)
        {
        ...
        public async Task<int> Create(ProductCreateRequest request)
        {
            ...
            foreach (var language in languages)
            {
                ...
                {
                    translations.Add(new ProductTranslations()
                    {
                        Name = request.Name,
                        Description = request.Description,
                        Details = request.Details,
                        SeoDescription = request.SeoDescription,
                        SeoAlials = request.SeoAlias,
                ...
                else
                {
                    translations.Add(new ProductTranslations()
                    {
                        ...
                        SeoAlials = SystemConstants.ProductConstants.NA,
        ...
        public async Task<ProductViewModel> GetById(int productId, string languageId)
        {
            ...
            var productViewModel = new ProductViewModel()
            {
                ...
                Price = product.Price,
                SeoAlias = productTranslation != null ? productTranslation.SeoAlials : null,
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            productTranslations.SeoAlials = request.SeoAlias;
